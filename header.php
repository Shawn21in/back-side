    ...
    <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
        <div class="nano">
            <div class="nano-content">
                <ul>
                    <li <?php if ($tempfilename=="index.php") {echo 'class="active"'; }?>>
                        <a href="index.php">
                            <i class="ti-home"></i> 管理者首頁
                        </a>
                    </li>		 
					<li <?php if ($tempfilename=="admin.php") {echo 'class="active"'; } ?>>
                        <a href="admin.php">
                            <i class="ti-control-record"></i> 1.管理者帳號維護
                        </a>
                    </li>
                    <li <?php if ($tempfilename=="member.php") {echo 'class="active"'; } ?>>
                        <a href="member.php">
                            <i class="ti-control-record"></i> 2.會員帳號維護
                        </a>
                    </li>	
                    <li <?php if ($tempfilename=="ch06-1.php") {echo 'class="active"'; } ?>>
                        <a href="ch06-1.php">
                            <i class="ti-control-record"></i> 3.與MySQL資料連結
                        </a>
                    </li>
                    <li <?php if ($tempfilename=="product.php") {echo 'class="active"'; } ?>>
                        <a href="product.php">
                            <i class="ti-control-record"></i> 4.查詢商品資料
                        </a>
                    </li>	                                        	
					<li>
                        <a href="login.php?st=logout">
                            <i class="ti-close"></i> 登出
                        </a>
                    </li>
                </ul>
            </div>
